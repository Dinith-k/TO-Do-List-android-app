...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    public ArrayList<NoteModel> getNotes() {
        ...
        if (cursor.moveToFirst()) {
            do {
                ...
                noteModel.setcolor_cd(cursor.getString(3));
    ...
    public ArrayList<String> getcatalist() {
    ...
    public ArrayList<String> getdescrip(String value) {
        ArrayList<String> arrayList = new ArrayList<>();

        // select all query
        String select_query= "SELECT *FROM " + TABLE_NAME+" WHERE "+Description+"='"+value+"'";
