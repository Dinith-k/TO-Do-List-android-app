...
DatabaseHealper2 database_helper2;
    public NotesAdapter2(Context context, Activity activity, ArrayList<NoteModel> arrayList) {
    ...
    @Override
    public NotesAdapter2.viewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        View view = LayoutInflater.from(context).inflate(R.layout.view2, viewGroup, false);
        return new NotesAdapter2.viewHolder(view);
    }



    @Override
    public void onBindViewHolder(final NotesAdapter2.viewHolder holder, final int position) {
       ...
       holder.delete.setOnClickListener(new View.OnClickListener() {;
            ...
            public void onClick(View v) {
                //deleting note
                database_helper = new DatabaseHelper(context);
                database_helper2 = new DatabaseHealper2(context);
                database_helper.delete(arrayList.get(position).getID());
                database_helper2.deleteRow(arrayList.get(position).getTitle());
    ...
    public class viewHolder extends RecyclerView.ViewHolder {
        ...
        public viewHolder(View itemView) {
            ...
            progressbard = (RoundCornerProgressBar)itemView.findViewById(R.id.progressbard);
             ...
             delete = (ImageButton) itemView.findViewById(R.id.delt);
               edit = (ImageButton) itemView.findViewById(R.id.edit2);
        }
    }
        ...
        submit.setOnClickListener(new View.OnClickListener() {;
            ...
            public void onClick(View v) {
                if (title.getText().toString().isEmpty()) {
                    ...
                    //updating note
                    database_helper.updateNote(title.getText().toString(),arrayList.get(pos).getDes(), arrayList.get(pos).getID());
                    arrayList.get(pos).setTitle(title.getText().toString());
                    arrayList.get(pos).setDes(des.getText().toString());

                   database_helper2.updateeRow(arrayList.get(pos).getTitle());
